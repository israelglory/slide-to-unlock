...
class _SlideToUnlockState extends State<SlideToUnlock> {
  ...
  void _updateDragPosition(Offset localPosition, BoxConstraints constraints) {
    const double padlockWidth = 60;
    final double maxDraggableWidth = constraints.maxWidth - padlockWidth;
    final double newDragPosition = localPosition.dx - (padlockWidth / 2);

    setState(() {
      _dragPosition = newDragPosition.clamp(0, maxDraggableWidth);
      _dragPercentage = _dragPosition / maxDraggableWidth;
    });
  }
